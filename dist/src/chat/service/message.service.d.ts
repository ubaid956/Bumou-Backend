...
export declare class MessageService {
    ...
    onNewMessage(message: ChatMessageDto): Promise<{
        message: string;
        chatroom?: undefined;
    } | {
        chatroom: any;
    ...
    getChatRoomsByUser(userId: string, page: number, pageSize: number): Promise<{
        unreadCount: number;
        _count: {
            messages: number;
        };
    ...
    getChatRoomById(chatroomId: string, userId: string): Promise<{
        _count: {
            messages: number;
        };
        messages: {
